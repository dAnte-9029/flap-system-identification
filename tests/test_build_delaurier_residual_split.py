...
from scripts.build_delaurier_residual_split import TARGET_COLUMNS, build_residual_frame, build_residual_split
...
def test_build_residual_split_writes_all_split_files(tmp_path: Path) -> None:
    ...
    build_residual_split(split_root, prior_root, output_root, prior_name="delaurier_physical")
